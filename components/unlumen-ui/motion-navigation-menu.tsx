  ...
  return (
    <HighlightItem asChild>
      ...
      >
        ...
        >
          <ChevronDownIcon className="size-3.5" strokeWidth={2.5} aria-hidden="true" />
        </motion.span>
      </button>
    </HighlightItem>
  );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden="true"
        data-slot="navigation-menu-measure"
        className="pointer-events-none invisible absolute left-0 top-1.5 w-max"
      >
        {activeContent && (
...
function MotionNavigationMenuIndicator({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-navy/10 shadow-subtle" />
    </div>
  );
}
